...
class Test(TestCase):
    ...
    def test_invalid_move_north_message(self, mock_stdout):
        board = {
            (0, 0): "A", (0, 1): "B",
            (1, 0): "C", (1, 1): "D"
        }
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_invalid_move_south_message(self, mock_stdout):
        board = {
            (0, 0): "A", (0, 1): "B",
            (1, 0): "C", (1, 1): "D"
        }
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_invalid_move_west_message(self, mock_stdout):
        board = {
            (0, 0): "A", (0, 1): "B",
            (1, 0): "C", (1, 1): "D"
        }
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_invalid_move_east_message(self, mock_stdout):
        board = {
            (0, 0): "A", (0, 1): "B",
            (1, 0): "C", (1, 1): "D"
        }
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_invalid_direction_message(self, mock_stdout):
        board = {
            (0, 0): "A", (0, 1): "B",
            (1, 0): "C", (1, 1): "D"
        }
